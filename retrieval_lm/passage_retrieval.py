...
class Retriever:
    ...
    def add_passages(self, passages, top_passages_and_scores):
        ...
        for i, doc_id in enumerate(top_passages_and_scores[0][0]):
            ...
            score = float(top_passages_and_scores[0][1][i]) # Get corresponding score
            passage_with_score = {
                "id": doc_id,
                "title": passage["title"],
                "text": passage["text"],
            ...
            docs.append(passage_with_score)
        return docs
...
def main(args):
    ...
    # Load the query data
    data_paths = glob.glob(args.query)
    for path in data_paths:
        ...
        for query_item in data:
            ...
            # Retrieve top passages for the query
            top_passages = retriever.search_document(query, args.n_docs)
    ...
    output_file = os.path.join(args.output_dir, "retrieval_results.jsonl")
